...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post carros_url, params: { carro: { ano: @carro.ano, chassi: @carro.chassi, modelo: @carro.modelo, placa: @carro.placa } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { ano: @carro.ano, chassi: @carro.chassi, modelo: @carro.modelo, placa: @carro.placa } }
